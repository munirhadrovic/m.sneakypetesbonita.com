...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://mobilegrows.com/" rel="external" >MobileGrows </a>|<a href="http://www.sneakypetesbonita.com/" rel="external"> Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page" data-transition="<?php echo $transitionefect ?>">ENTERTAINMENT</a></div>
				</div>

              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#service" data-transition="<?php echo $transitionefect ?>">HAPPY HOURS</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">MENU</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">PHOTOS</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#service" data-transition="<?php echo $transitionefect ?>">MERCHANDISE</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">BULLETIN BOARD</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">ENTERTAINMENT</a></li>
							<li><a href="#service" data-transition="<?php echo $transitionefect ?>">HAPPY HOURS</a></li>
							<li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">MENU</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">PHOTOS</a></li>
                            <li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">MERCHANDISE</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">BULLETIN BOARD</a></li>
