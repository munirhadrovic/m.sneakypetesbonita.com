<?php
$adresa="3465 Bonita Beach Road Bonita Springs,FLORIDA 34134"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
$skracenica=""; // AKo ne znate skracenicu ostavite praznu
$telephone=2394988887;// Broj koji se poziva na dugme CALL US
